...
function TemperatureAndDetails({weather:{details,icon,temp,temp_min,temp_max,sunrise,sunset,speed, humidity,feels_like,timezone}}) {
  ...
  return (
    <div>
      <div className="flex items-center justify-center text-cyan-300 py-6">
        <p>{details}</p>
      </div>
      <div className="flex flex-row items-center justify-between text-white py-3">
        ...
        <img src={iconUrlFromCode(icon)} alt="weather i<con" className="w-12 h-12 "/>
...
<div className="flex items-center justify-center text-white py-3 space-x-2 text-sm">
  <RiSunFill/>
